...
function simbol_bencana($type_bencana,$type_disaster){
	if(open_connection()){
		if(!empty($type_bencana) && $type_bencana==1){
			...
			//location_type_code,package_id,char_information_message,section_number,last_section_number
			mysql_query("INSERT INTO tmdw VALUES(1,1,'Seluruh masyarakat untuk segera mengungsi, daerah anda rawan Abarasi...',0,2),
			...
			//disaster-Type_code,disaster_code,package_id,location_code,char_location_code,section_number,last_section_number
			mysql_query("INSERT INTO trdw VALUES(1,14,1,'$kodepos_1','Desa Penjaringan',0,2),
			(2,14,1,'$kodepos_2','Desa Pejagalan',1,2),
			(3,14,1,'$kodepos_3','Desa Kapuk Muara',2,2)");
			//Packet_id,authority,disaster_code,char_disater_code,char_disaster_position,char_disaster_date,char_disaster_characteristic,
			//section_number,last_section_number
			mysql_query("INSERT INTO tcdw VALUES(1,2,14,'Konflik Sosial','1.33LU 93.05BT Kecamatan Penjaringan','11/05/2013 Jam:15:38 WIB','Tawuran antar Kelompok',0,0)");
			//location_type_code,package_id,char_information_message,section_number,last_section_number
			...
			//Packet_id,authority,disaster_code,char_disater_code,char_disaster_position,char_disaster_date,char_disaster_characteristic,
			//section_number,last_section_number
			mysql_query("INSERT INTO tcdw VALUES(1,2,15,'Cadangan','Cadangan','11/05/2013 Jam:15:38 WIB','Cadangan',0,0)");
			//location_type_code,package_id,char_information_message,section_number,last_section_number
			mysql_query("INSERT INTO tmdw VALUES(1,1,'Cadangan...',0,2),
			(2,1,'Cadangan...',1,2),
			(3,1,'Cadangan...',2,2)");
		}
	}
